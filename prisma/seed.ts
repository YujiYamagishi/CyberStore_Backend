...
async function main() {
    ...
    await prisma.product.createMany({
        data: [
            { id: 1, name: 'iPhone 15 Pro', description: 'The first iPhone forged in aerospace-grade titanium. Features the game-changing A17 Pro chip, a customizable Action button, and the most powerful iPhone camera system ever.', brand: 'Apple', price: 9299, stock: 50, url_image: 'https://source.unsplash.com/random/800x600?iphone,pro,titanium', tag: 'bestseller', id_category: 1, id_specs_smartphone: 1 },
            { id: 2, name: 'Samsung Galaxy S24 Ultra', description: 'Welcome to the era of mobile AI. With Galaxy S24 Ultra, you can unleash whole new levels of creativity, productivity and possibility, starting with the most important device in your life.', brand: 'Samsung', price: 8999, discounted_price: 8499, stock: 40, url_image: 'https://source.unsplash.com/random/800x600?samsung,s24,ultra,phone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 2 },
            { id: 3, name: 'Google Pixel 8 Pro', description: 'The Pixel 8 Pro is the most powerful, personal, and secure Pixel phone yet, with a pro-level camera system and the helpfulness of Google AI.', brand: 'Google', price: 7999, stock: 35, url_image: 'https://source.unsplash.com/random/800x600?google,pixel,pro,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 3 },
            { id: 4, name: 'Xiaomi 14 Pro', description: 'A masterpiece of mobile photography with a Leica professional optical lens and the latest Snapdragon processor for unmatched performance.', brand: 'Xiaomi', price: 5499, discounted_price: 5199, stock: 30, url_image: 'https://source.unsplash.com/random/800x600?xiaomi,phone,14', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 4 },
            { id: 5, name: 'Samsung Galaxy Z Fold 5', description: 'A massive, immersive screen that fits in your pocket. The ultimate productivity powerhouse with PC-like multitasking.', brand: 'Samsung', price: 11999, stock: 20, url_image: 'https://source.unsplash.com/random/800x600?samsung,foldable,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 5 },
            { id: 6, name: 'iPhone 15', description: 'Now with Dynamic Island, a 48MP main camera, and USB-C, all in a durable color-infused glass and aluminum design.', brand: 'Apple', price: 7299, discounted_price: 6999, stock: 60, url_image: 'https://source.unsplash.com/random/800x600?iphone,15,blue', tag: 'bestseller', id_category: 1, id_specs_smartphone: 1 },
            { id: 7, name: 'Google Pixel 8', description: 'The helpful phone, engineered by Google. Amazing photos and videos every time with the power of Google AI.', brand: 'Google', price: 5999, stock: 45, url_image: 'https://source.unsplash.com/random/800x600?google,pixel,8', tag: 'bestseller', id_category: 1, id_specs_smartphone: 3 },
            { id: 8, name: 'Motorola Razr 40 Ultra', description: 'Flip the script with the iconic foldable design featuring a huge, fully functional external screen.', brand: 'Motorola', price: 6999, discounted_price: 6499, stock: 25, url_image: 'https://source.unsplash.com/random/800x600?motorola,razr,phone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 5 },
            { id: 9, name: 'Samsung Galaxy A55', description: 'Awesome camera, awesome screen, awesome battery. All you need in a durable, stylish package.', brand: 'Samsung', price: 2499, stock: 100, url_image: 'https://source.unsplash.com/random/800x600?samsung,galaxy,a55', tag: 'bestseller', id_category: 1, id_specs_smartphone: 2 },
            { id: 10, name: 'Asus ROG Phone 8', description: 'The ultimate gaming phone is back, with unmatched performance, a revolutionary cooling system, and pro-level gaming features.', brand: 'Asus', price: 8999, discounted_price: 8799, stock: 15, url_image: 'https://source.unsplash.com/random/800x600?asus,gaming,phone,rog', tag: 'featured_product', id_category: 1, id_specs_smartphone: 2 },
            { id: 11, name: 'OnePlus 12', description: 'A flagship powerhouse with a stunning display and incredibly fast charging.', brand: 'OnePlus', price: 6299, stock: 28, url_image: 'https://source.unsplash.com/random/800x600?oneplus,phone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 4 },
            { id: 12, name: 'iPhone 14', description: 'A great upgrade with significant camera improvements and Crash Detection.', brand: 'Apple', price: 5999, stock: 70, url_image: 'https://source.unsplash.com/random/800x600?iphone,14,purple', tag: 'discount_up_to_50', id_category: 1, id_specs_smartphone: 1 },
            { id: 13, name: 'Samsung Galaxy Z Flip 5', description: 'The pocket-sized foldable with a massive Flex Window for ultimate self-expression.', brand: 'Samsung', price: 7999, discounted_price: 7499, stock: 33, url_image: 'https://source.unsplash.com/random/800x600?samsung,flip,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 5 },
            { id: 14, name: 'Google Pixel 7a', description: 'The essential Pixel phone, bringing amazing features at a great price.', brand: 'Google', price: 3599, stock: 80, url_image: 'https://source.unsplash.com/random/800x600?google,pixel,7a', tag: 'bestseller', id_category: 1, id_specs_smartphone: 3 },
            { id: 15, name: 'Xiaomi Redmi Note 13', description: 'A fantastic mid-range option with a high-resolution camera and long battery life.', brand: 'Xiaomi', price: 1899, stock: 120, url_image: 'https://source.unsplash.com/random/800x600?xiaomi,redmi,phone', tag: 'bestseller', id_category: 1, id_specs_smartphone: 4 },
            { id: 16, name: 'Motorola Edge 40 Neo', description: 'Slim, light, and stylish with a powerful camera system and vivid display.', brand: 'Motorola', price: 3499, discounted_price: 3299, stock: 55, url_image: 'https://source.unsplash.com/random/800x600?motorola,edge,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 5 },
            { id: 17, name: 'iPhone SE (3rd Gen)', description: 'Serious power with the A15 Bionic chip in the iconic iPhone design.', brand: 'Apple', price: 4299, stock: 90, url_image: 'https://source.unsplash.com/random/800x600?iphone,se', tag: 'bestseller', id_category: 1, id_specs_smartphone: 1 },
            { id: 18, name: 'Samsung Galaxy S23 FE', description: 'Fan Edition is back with pro-grade features for everyone.', brand: 'Samsung', price: 4499, discounted_price: 4199, stock: 65, url_image: 'https://source.unsplash.com/random/800x600?samsung,s23,fe', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 2 },
            { id: 19, name: 'Sony Xperia 1 V', description: 'A smartphone for photographers, with next-gen sensor technology.', brand: 'Sony', price: 9999, stock: 10, url_image: 'https://source.unsplash.com/random/800x600?sony,xperia,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 2 },
            { id: 20, name: 'Nothing Phone (2)', description: 'A unique design with the Glyph Interface and a refined user experience.', brand: 'Nothing', price: 4599, stock: 22, url_image: 'https://source.unsplash.com/random/800x600?nothing,phone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 4 },
            { id: 21, name: 'Oppo Find X6 Pro', description: 'Co-engineered with Hasselblad for a pro-level camera experience.', brand: 'Oppo', price: 7500, stock: 18, url_image: 'https://source.unsplash.com/random/800x600?oppo,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 2 },
            { id: 22, name: 'Vivo X90 Pro', description: 'Exceptional low-light photography capabilities and fast performance.', brand: 'Vivo', price: 7200, stock: 21, url_image: 'https://source.unsplash.com/random/800x600?vivo,phone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 4 },
            { id: 23, name: 'Realme GT Neo 5', description: 'Blazing-fast charging speeds and a powerful chipset for gaming.', brand: 'Realme', price: 3800, discounted_price: 3500, stock: 40, url_image: 'https://source.unsplash.com/random/800x600?realme,phone', tag: 'bestseller', id_category: 1, id_specs_smartphone: 4 },
            { id: 24, name: 'Huawei P60 Pro', description: 'Variable aperture camera system for stunning versatility in photography.', brand: 'Huawei', price: 8100, stock: 12, url_image: 'https://source.unsplash.com/random/800x600?huawei,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 2 },
            { id: 25, name: 'Nokia G42', description: 'A sustainable choice, designed for easy repairability at home.', brand: 'Nokia', price: 1500, stock: 110, url_image: 'https://source.unsplash.com/random/800x600?nokia,phone', tag: 'discount_up_to_50', id_category: 1, id_specs_smartphone: 5 },
            { id: 26, name: 'Fairphone 5', description: 'The most sustainable and ethical smartphone on the market.', brand: 'Fairphone', price: 5500, stock: 30, url_image: 'https://source.unsplash.com/random/800x600?fairphone', tag: 'new_arrival', id_category: 1, id_specs_smartphone: 4 },
            { id: 27, name: 'CAT S75', description: 'An ultra-rugged smartphone built to survive extreme conditions.', brand: 'CAT', price: 4200, stock: 25, url_image: 'https://source.unsplash.com/random/800x600?rugged,phone', tag: 'featured_product', id_category: 1, id_specs_smartphone: 5 },
            { id: 28, name: 'iPhone 13 Mini', description: 'Pocket-sized power with the A15 Bionic chip.', brand: 'Apple', price: 5699, discounted_price: 5199, stock: 40, url_image: 'https://source.unsplash.com/random/800x600?iphone,mini', tag: 'bestseller', id_category: 1, id_specs_smartphone: 1 },
            { id: 29, name: 'Samsung Galaxy S23 FE', description: 'The Fan Edition returns with a powerful camera and flagship performance.', brand: 'Samsung', price: 3999, stock: 70, url_image: 'https://source.unsplash.com/random/800x600?samsung,fe', tag: 'bestseller', id_category: 1, id_specs_smartphone: 2 },
            { id: 30, name: 'Xiaomi Poco F5', description: 'Incredible performance for gaming and multitasking at a mid-range price.', brand: 'Xiaomi', price: 2999, stock: 85, url_image: 'https://source.unsplash.com/random/800x600?xiaomi,poco', tag: 'featured_product', id_category: 1, id_specs_smartphone: 4 },
            ...
            { id: 201, name: 'iPad Pro 11" M4', description: 'The ultimate iPad experience, now with the outrageous power of the M4 chip, a breakthrough Ultra Retina XDR display, and superfast Wi-Fi 6E.', brand: 'Apple', price: 12299, stock: 30, url_image: 'https://source.unsplash.com/random/800x600?ipad,pro,desk', tag: 'bestseller', id_category: 3 },
            { id: 202, name: 'Samsung Galaxy Tab S9 Ultra', description: 'A massive 14.6-inch Dynamic AMOLED 2X display that’s a feast for the eyes. Includes the S Pen for ultimate creativity and note-taking.', brand: 'Samsung', price: 9999, discounted_price: 9499, stock: 25, url_image: 'https://source.unsplash.com/random/800x600?samsung,galaxy,tab', tag: 'new_arrival', id_category: 3 },
            { id: 203, name: 'Microsoft Surface Pro 9', description: 'The versatility of a tablet and the performance of a laptop.', brand: 'Microsoft', price: 8999, stock: 35, url_image: 'https://source.unsplash.com/random/800x600?microsoft,surface,pro', tag: 'featured_product', id_category: 3 },
            { id: 204, name: 'iPad Air M2', description: 'Powerful, colorful, and versatile, now supercharged by the M2 chip.', brand: 'Apple', price: 6999, stock: 50, url_image: 'https://source.unsplash.com/random/800x600?ipad,air', tag: 'bestseller', id_category: 3 },
            { id: 205, name: 'Lenovo Tab P12', description: 'A large 12.7-inch 3K display for cinematic entertainment and productivity.', brand: 'Lenovo', price: 3499, discounted_price: 3199, stock: 45, url_image: 'https://source.unsplash.com/random/800x600?lenovo,tablet', tag: 'new_arrival', id_category: 3 },
            { id: 206, name: 'Xiaomi Pad 6', description: 'A flagship-level tablet for work and entertainment with a 144Hz display.', brand: 'Xiaomi', price: 2999, stock: 60, url_image: 'https://source.unsplash.com/random/800x600?xiaomi,pad', tag: 'featured_product', id_category: 3 },
            { id: 207, name: 'Amazon Fire Max 11', description: 'Amazon’s biggest and most powerful tablet, built for entertainment and light work.', brand: 'Amazon', price: 1899, stock: 80, url_image: 'https://source.unsplash.com/random/800x600?amazon,fire,tablet', tag: 'bestseller', id_category: 3 },
            { id: 208, name: 'Google Pixel Tablet', description: 'The only tablet with a Charging Speaker Dock that turns it into a smart home hub.', brand: 'Google', price: 4999, stock: 28, url_image: 'https://source.unsplash.com/random/800x600?google,pixel,tablet', tag: 'new_arrival', id_category: 3 },
            { id: 209, name: 'OnePlus Pad', description: 'Features the world’s first 7:5 ratio display for a unique reading and browsing experience.', brand: 'OnePlus', price: 4299, discounted_price: 3999, stock: 33, url_image: 'https://source.unsplash.com/random/800x600?oneplus,pad', tag: 'featured_product', id_category: 3 },
            { id: 210, name: 'Samsung Galaxy Tab A9+', description: 'A great value tablet for family entertainment and everyday tasks.', brand: 'Samsung', price: 1499, stock: 100, url_image: 'https://source.unsplash.com/random/800x600?samsung,tab,a9', tag: 'discount_up_to_50', id_category: 3 },

            { id: 301, name: 'AirPods Pro (2nd gen)', description: 'Richer audio quality, next-level Active Noise Cancellation, and Adaptive Transparency. Personalized Spatial Audio provides an immersive experience.', brand: 'Apple', price: 2599, stock: 100, url_image: 'https://source.unsplash.com/random/800x600?airpods,pro', tag: 'bestseller', id_category: 4 },
            { id: 302, name: 'Sony WH-1000XM5', description: 'Industry-leading noise canceling with two processors controlling eight microphones. A new standard in clear call quality and premium sound.', brand: 'Sony', price: 2399, discounted_price: 2199, stock: 50, url_image: 'https://source.unsplash.com/random/800x600?sony,headphones', tag: 'featured_product', id_category: 4 },
            { id: 303, name: 'Bose QuietComfort Ultra Headphones', description: 'World-class noise cancellation and groundbreaking Bose Immersive Audio.', brand: 'Bose', price: 2999, stock: 45, url_image: 'https://source.unsplash.com/random/800x600?bose,headphones', tag: 'new_arrival', id_category: 4 },
            { id: 304, name: 'Sennheiser Momentum 4', description: 'Enjoy exceptional sound with this audiophile-inspired headphone featuring a 60-hour battery life.', brand: 'Sennheiser', price: 2199, stock: 55, url_image: 'https://source.unsplash.com/random/800x600?sennheiser,headphones', tag: 'featured_product', id_category: 4 },
            { id: 305, name: 'AirPods Max', description: 'A perfect balance of exhilarating high-fidelity audio and the effortless magic of AirPods.', brand: 'Apple', price: 5999, discounted_price: 5499, stock: 25, url_image: 'https://source.unsplash.com/random/800x600?airpods,max', tag: 'bestseller', id_category: 4 },
            { id: 306, name: 'JBL Tour One M2', description: 'True Adaptive Noise Cancelling technology for an immersive audio experience.', brand: 'JBL', price: 1499, stock: 70, url_image: 'https://source.unsplash.com/random/800x600?jbl,headphones', tag: 'new_arrival', id_category: 4 },
            { id: 307, name: 'Beats Studio Pro', description: 'Fully adaptive Active Noise Cancelling and lossless audio for an emotional listening experience.', brand: 'Beats', price: 2299, stock: 65, url_image: 'https://source.unsplash.com/random/800x600?beats,headphones', tag: 'featured_product', id_category: 4 },
            { id: 308, name: 'Anker Soundcore Space Q45', description: 'Upgraded noise cancelling and ultra-long playtime for an affordable price.', brand: 'Anker', price: 999, stock: 90, url_image: 'https://source.unsplash.com/random/800x600?anker,headphones', tag: 'bestseller', id_category: 4 },
            { id: 309, name: 'Audio-Technica ATH-M50x', description: 'Critically acclaimed studio monitor headphones for professional use.', brand: 'Audio-Technica', price: 899, stock: 85, url_image: 'https://source.unsplash.com/random/800x600?audio,technica,headphones', tag: 'featured_product', id_category: 4 },
            { id: 310, name: 'Edifier W820NB', description: 'Hybrid Active Noise Cancelling headphones with Hi-Res Audio certification.', brand: 'Edifier', price: 499, stock: 120, url_image: 'https://source.unsplash.com/random/800x600?edifier,headphones', tag: 'discount_up_to_50', id_category: 4 },

            { id: 401, name: 'PlayStation 5 Slim Console', description: 'Experience lightning-fast loading with an ultra-high-speed SSD, deeper immersion with support for haptic feedback, and an all-new generation of incredible PlayStation games.', brand: 'Sony', price: 4799, stock: 40, url_image: 'https://source.unsplash.com/random/800x600?playstation,5,console', tag: 'bestseller', id_category: 5 },
            { id: 402, name: 'Xbox Series X Console', description: 'The fastest, most powerful Xbox ever. Explore rich new worlds with 12 teraflops of raw graphic processing power, DirectX ray tracing, and a custom SSD.', brand: 'Microsoft', price: 4899, stock: 35, url_image: 'https://source.unsplash.com/random/800x600?xbox,series,x,console', tag: 'featured_product', id_category: 5 },
            { id: 403, name: 'Nintendo Switch OLED Model', description: 'Play at home on the TV or on-the-go with a vibrant 7-inch OLED screen. Features a wide adjustable stand, a dock with a wired LAN port, and 64 GB of internal storage.', brand: 'Nintendo', price: 2499, discounted_price: 2399, stock: 60, url_image: 'https://source.unsplash.com/random/800x600?nintendo,switch,oled', tag: 'new_arrival', id_category: 5 },
            { id: 404, name: 'Logitech G Pro X Superlight Mouse', description: 'An ultra-lightweight wireless gaming mouse for professional gamers.', brand: 'Logitech', price: 899, stock: 100, url_image: 'https://source.unsplash.com/random/800x600?logitech,gaming,mouse', tag: 'bestseller', id_category: 5 },
            { id: 405, name: 'Razer BlackWidow V4 Pro Keyboard', description: 'A mechanical gaming keyboard with Razer Chroma RGB and dedicated macro keys.', brand: 'Razer', price: 1499, discounted_price: 1399, stock: 70, url_image: 'https://source.unsplash.com/random/800x600?razer,keyboard', tag: 'featured_product', id_category: 5 },
            { id: 406, name: 'SteelSeries Arctis Nova Pro Headset', description: 'Achieve almighty audio levels with the Nova Pro Acoustic System and premium Hi-Res drivers.', brand: 'SteelSeries', price: 2199, stock: 55, url_image: 'https://source.unsplash.com/random/800x600?steelseries,headset', tag: 'new_arrival', id_category: 5 },
            { id: 407, name: 'DualSense Edge Wireless Controller', description: 'Get an edge in gameplay with this high-performance controller built for PlayStation 5.', brand: 'Sony', price: 1499, stock: 65, url_image: 'https://source.unsplash.com/random/800x600?dualsense,edge,controller', tag: 'bestseller', id_category: 5 },
            { id: 408, name: 'Xbox Elite Series 2 Controller', description: 'Play like a pro with the world’s most advanced controller, featuring adjustable-tension thumbsticks.', brand: 'Microsoft', price: 1299, stock: 75, url_image: 'https://source.unsplash.com/random/800x600?xbox,elite,controller', tag: 'featured_product', id_category: 5 },
            { id: 409, name: 'Elgato Stream Deck MK.2', description: '15 customizable LCD keys to control your apps and tools.', brand: 'Elgato', price: 999, stock: 80, url_image: 'https://source.unsplash.com/random/800x600?elgato,stream,deck', tag: 'new_arrival', id_category: 5 },
            { id: 410, name: 'Steam Deck OLED', description: 'A powerful, portable PC gaming device with a vibrant OLED screen.', brand: 'Valve', price: 4499, stock: 30, url_image: 'https://source.unsplash.com/random/800x600?steam,deck', tag: 'discount_up_to_50', id_category: 5 },
            ...
            { id: 701, name: 'Apple Watch Ultra 2', description: 'The most rugged and capable Apple Watch ever, designed for exploration, adventure, and endurance. Features a bright display and a magical new way to interact.', brand: 'Apple', price: 9699, stock: 30, url_image: 'https://source.unsplash.com/random/800x600?apple,watch,ultra', tag: 'bestseller', id_category: 8 },
            { id: 702, name: 'Samsung Galaxy Watch 6 Classic', description: 'The iconic rotating bezel is back, with a larger display and advanced wellness tracking. Crush your fitness goals and monitor your health.', brand: 'Samsung', price: 3199, discounted_price: 2999, stock: 40, url_image: 'https://source.unsplash.com/random/800x600?samsung,galaxy,watch', tag: 'featured_product', id_category: 8 },
            { id: 703, name: 'Garmin Fenix 7 Pro', description: 'The ultimate multisport GPS watch with solar charging and built-in flashlight.', brand: 'Garmin', price: 7999, stock: 25, url_image: 'https://source.unsplash.com/random/800x600?garmin,watch', tag: 'new_arrival', id_category: 8 },
            { id: 704, name: 'Apple Watch Series 9', description: 'Your essential companion for a healthy life is now even more powerful.', brand: 'Apple', price: 4999, stock: 80, url_image: 'https://source.unsplash.com/random/800x600?apple,watch,series,9', tag: 'bestseller', id_category: 8 },
            { id: 705, name: 'Google Pixel Watch 2', description: 'The best of Google and Fitbit, with a new sensor for more accurate health tracking.', brand: 'Google', price: 2999, stock: 50, url_image: 'https://source.unsplash.com/random/800x600?pixel,watch', tag: 'featured_product', id_category: 8 },
            { id: 706, name: 'Fitbit Charge 6', description: 'Get motivated to move more with Google essentials and advanced health sensors.', brand: 'Fitbit', price: 1299, stock: 90, url_image: 'https://source.unsplash.com/random/800x600?fitbit,watch', tag: 'new_arrival', id_category: 8 },
            { id: 707, name: 'Amazfit T-Rex 2', description: 'A rugged outdoor GPS smartwatch with military-grade toughness.', brand: 'Amazfit', price: 1599, discounted_price: 1399, stock: 60, url_image: 'https://source.unsplash.com/random/800x600?amazfit,watch', tag: 'bestseller', id_category: 8 },
            { id: 708, name: 'Huawei Watch GT 4', description: 'An elegant design with comprehensive health and fitness tracking.', brand: 'Huawei', price: 1899, stock: 45, url_image: 'https://source.unsplash.com/random/800x600?huawei,watch', tag: 'featured_product', id_category: 8 },
            { id: 709, name: 'Xiaomi Smart Band 8', description: 'A stylish fitness tracker with a versatile design and long battery life.', brand: 'Xiaomi', price: 399, stock: 150, url_image: 'https://source.unsplash.com/random/800x600?xiaomi,band', tag: 'new_arrival', id_category: 8 },
            { id: 710, name: 'Garmin Forerunner 265', description: 'A brilliant AMOLED display and training metrics to help you push your limits.', brand: 'Garmin', price: 3999, stock: 35, url_image: 'https://source.unsplash.com/random/800x600?garmin,forerunner', tag: 'discount_up_to_50', id_category: 8 },
        ]
    });
