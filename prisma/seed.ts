...
async function main() {
    ...
    await prisma.product.createMany({
        data: [
            ...
            ...Array.from({ length: 20 }, (_, i) => ({ id: 31 + i, name: `Generic Phone Model ${i + 1}`, description: `A reliable phone from Brand ${i % 5 + 1}`, brand: ['Apple', 'Samsung', 'Xiaomi', 'Motorola', 'OnePlus'][i % 5], price: 1999 + i * 150, discounted_price: (i % 3 === 0) ? 1899 + i * 150 : undefined, stock: 50 + i * 2, url_image: `https://source.unsplash.com/random/800x600?smartphone,${['Apple', 'Samsung', 'Xiaomi', 'Motorola', 'OnePlus'][i % 5]}`, tag: 'bestseller', id_category: 1, id_specs_smartphone: (i % 5) + 1 })),
